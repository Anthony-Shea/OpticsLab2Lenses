...
We measured the image distance and object distance for a converging lens to determine the focal length of the lens.
...
We wanted to use an estimate of the focal length before actually measuring the image distance and object distance.
If the focal length is not too large and the image distance is large compared to the object distance, the focal lenght and image distance should be similar.
